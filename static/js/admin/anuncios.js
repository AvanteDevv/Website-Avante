...
function setupAdDateTimeField(prefix){
  ...
  function floatMenu(trigger, menu){
    ...
    if (idealTop + menuHeight > window.innerHeight - margin) {
      // no cabe abajo: se intenta arriba del botón
      idealTop = r.top - menuHeight - 8;
    }
    // pase lo que pase, nunca se sale de la pantalla — se pega al borde
    // más cercano si ni arriba ni abajo hay espacio de sobra.
